package br.com.rramirez.dao.generic.jdbc.dao.cliente;

import br.com.rramirez.dao.generic.jdbc.ConnectionFactoryCliente;
...
public class ClienteDAO implements IClienteDAO {
    ...
    public Integer cadastrar(Cliente cliente) throws Exception {
        ...
        try{
            connection = ConnectionFactoryCliente.getConnection();
    ...
    private String getSqlInsert() {
        ...
        sb.append("INSERT INTO CLIENTE (NOME, CODIGO)");
        sb.append(" VALUES (?, ?)");
        return sb.toString();
    }
